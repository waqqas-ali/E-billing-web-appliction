...
//     "ANDHRA_PRADESH", "ARUNACHAL_PRADESH", "ASSAM", "BIHAR", "CHHATTISGARH", "GOA", "GUJARAT", "HARYANA",
//     "HIMACHAL_PRADESH", "JHARKHAND", "KARNATAKA", "KERALA", "MADHYA_PRADESH", "MAHARASHTRA", "MANIPUR",
//     "MEGHALAYA", "MIZORAM", "NAGALAND", "ODISHA", "PUNJAB", "RAJASTHAN", "SIKKIM", "TAMIL_NADU", "TELANGENA",
//     "TRIPURA", "UTTAR_PRADESH", "UTTARAKHAND", "WEST_BENGAL", "OTHER",
//   ];
//   const units = [
//     "CARTONS", "KILOGRAMS", "QUINTAL", "BOTTLES", "PIECES", "ROLLS", "NUMBERS", "PAIRS", "TABLETS",
...
//   // Return number helpers
//   const getNextReturnNumberPreview = () => {
//     if (!companyId) return "SR/NEW";
//     const year = new Date().getFullYear();
//     const key = `saleReturnCounter_${companyId}_${year}`;
//     const counter = parseInt(localStorage.getItem(key) || "0", 10);
//     return `SR/${year}/${counter + 1}`;
//   };
...
//     return `SR/${year}/${counter}`;
//   };

//   // Preview return number for new returns
//   useEffect(() => {
...
//   // Auto-fill phone number and state
//   useEffect(() => {
//     if (!form.partyId || parties.length === 0) return;
...
//     if (value === "SR" || value === "SR/" || value.startsWith("SR/")) {
...
//                   required
//                   className={styles.input}
//                   placeholder="Type SR to auto-generate"
    ...
    const payload = {
      ...
      saleReturnItemRequests: form.items.map((i) => {
        ...
        if (i.itemId && i.itemId !== "") {
          itemObj.itemId = Number(i.itemId);
        }
