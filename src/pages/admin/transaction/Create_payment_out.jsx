...
const Create_payment_out = () => {
  ...
  const getNextReceiptNumberPreview = () => {
    if (!companyId) return "PAY/NEW";
    const year = new Date().getFullYear();
    const key = `paymentOutReceiptCounter_${companyId}_${year}`;
    const counter = parseInt(localStorage.getItem(key) || "0", 10);
    return `PAY/${year}/${counter + 1}`;
  };
  ...
  const handleReceiptNoChange = (e) => {
    ...
    if (value === "PAY" || value === "PAY/" || value.startsWith("PAY/")) {
            ...
            <div className={styles.formGrid}>
              ...
              <div className={styles.formGroup}>
                ...
                <input
                  ...
                  required
                  className={styles.input}
                  placeholder="Type PAY to auto-generate"
