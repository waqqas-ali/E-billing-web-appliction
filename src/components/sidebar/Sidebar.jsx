...
import {
  ...
  FileBarChart,        // New: for reports (lucide-react has this)
  ReceiptText,         // Alternative report icon
} from "lucide-react";
...
const Sidebar = () => {
  ...
  const [isExpenseOpen, setIsExpenseOpen] = useState(false);
  const [isTransactionOpen, setIsTransactionOpen] = useState(false);
  const [isReportsOpen, setIsReportsOpen] = useState(false); // New state
              ...
              <div className={styles.menuItems}>
                ...
                <div className={styles.submenuWrapper}>
                  <button
                    ...
                    className={styles.navItem}
                  >
                    <FileBarChart className={styles.navIcon} />
                  ...
                  {isReportsOpen && (
                    <div className={styles.submenu}>
                      <NavItem to="bill_profit_loss_report" icon={ReceiptText}>
                        Bill Profit Loss Report
                      </NavItem>
                      <NavItem to="profit_loss_report" icon={FileBarChart}>
                        Profit Loss Report
                      </NavItem>
                      <NavItem to="parties_report" icon={Users2}>
                        Parties Report
                      </NavItem>
                      <NavItem to="purchase_report" icon={ShoppingCart}>
                        Purchase Report
                      </NavItem>
